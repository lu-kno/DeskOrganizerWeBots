...
\begin{blocknotice}
  ...
  % The following work contains confidential information and data of ThyssenKrupp AG. 
  
  % Publication or reproduction - even in part or in electronic form - is not permitted without the express written approval of ThyssenKrupp AG.

  % The blocking period is valid until December 31, 2032.

  % Until the expiry of the blocking period, the work may only be used for examination purposes.

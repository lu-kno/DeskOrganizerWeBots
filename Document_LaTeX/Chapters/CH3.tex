...
\begin{figure}[!h]
    \centering
    \adjincludegraphics[width=1\textwidth]{Figures/cvResultExistingModel.jpg}
...
\begin{figure}[!h]
    \centering
    \adjincludegraphics[width=1\textwidth]{Figures/image_344.jpg}
    \caption{Figure 3: image\_344.jpg in image directory  }
    \label{fig:dataset_train_img}
\end{figure}

\begin{figure}[!h]
    \centering
    \adjincludegraphics[width=1\textwidth]{Figures/image_344.txt.jpg}
    \caption{Figure 4: image\_344.txt in annotations directory  }
...
\subsubsection{Movement Routine}
